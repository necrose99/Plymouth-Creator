...
class Handler:
  def on_selectVideoButton_clicked(self, button):
    ...
    videoInputFile = tkinter.filedialog.askopenfilename(parent=root,initialdir="/home",title='Select your .mp4 video',filetypes = (("mp4 files","*.mp4"),("all files","*.*")))
  ...
  def on_selectVideoOutputButton_clicked(self, button):
    ...
    videoOutputDirectory = tkinter.filedialog.askdirectory(parent=root,initialdir="/home",title='Select an empty output directory')
  ...
  def on_selectDirectoryButton_clicked(self, button):
    global outputDirectory
    outputDirectory = tkinter.filedialog.askdirectory(parent=root,initialdir="/home",title='Select directory with .png files')
